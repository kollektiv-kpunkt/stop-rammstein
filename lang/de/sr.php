...
return [
    ...
    "landing" => [
        ...
        "lead" => "Die Vorwürfe gegen den Rammstein-Leadsänger Till Lindemann bezüglich sexualisierter Gewalt müssen ernst genommen werden! Wir fordern den Konzertveranstalter auf, die Rammsteinkonzerte in Bern abzusagen! Der Veranstalter muss die Betroffenen ernst nehmen und die Sicherheit der Konzertteilnehmer*innen sicherstellen.<br><b class=\"font-bold\">Unterschreibe die Petition!</b>",
        "petition" => [
            "content" => [
                "Der Frontsänger der Band Rammstein, Till Lindemann, ist mit harten Vorwürfen von sexualisierter Gewalt konfrontiert. Immer mehr Betroffene erzählen in übereinstimmender Art und Weise von Übergriffen und Machtmissbrauch, die sich laut ihren Berichten bei den Konzerten der Band zugetragen haben. Trotzdem hält der Schweizer Konzertveranstalter Gadget abc daran fest, die Rammsteinkonzerte am 17. und 18. Juni im Wankdorfstadion in Bern durchzuführen. Das geht nicht!",
                ...
                "<b>Wir fordern den Konzertveranstalter Gadget abc dazu auf, in dieser Situation die richtigen Konsequenzen zu ziehen, die Rammsteinkonzerte in Bern abzusagen und den Konzertbesucher*innen den vollen Ticketpreis zurückzuerstatten.</b>"
            ],
